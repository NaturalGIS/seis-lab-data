...
class GDALReader:
    ...
    def extract_metadata(self, path):
        ...
        metadata = {
            ...
            "raster": {},
            "vector": {},
            "survey": {},  # placeholder for specialized formats
            "error_no": 0,
            "error_type": 0,
            "messages": "",
        }
        ...
        try:
            ...
            metadata["message"] = gdal.GetLastErrorMsg()
            return metadata
        ...
        if ds is not None:
            try:
                ...
                # Again, let's get the GeoTransform if
                # defined or inferred by GDAL
            ...
            metadata["message"] = GDALReader.warning_notes
            return metadata
